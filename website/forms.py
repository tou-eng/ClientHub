...
class AddRecordForm(forms.ModelForm):
    ...
    phone_number= forms.CharField(label='', required=True, max_length=15, widget=forms.TextInput(attrs={'class':'form-control','placeholder':'Phone Number'}))
    address= forms.CharField(label='', required=True, max_length=200, widget=forms.TextInput(attrs={'class':'form-control','placeholder':'Address'}))
    ...
    class Meta:
        model = Record
        fields = ('first_name','last_name','email','phone_number','address','state','city')
